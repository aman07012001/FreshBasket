...
function OrderNotification({ message, type = 'info', duration = 5000, onDismiss }) {
      ...
      <div className="flex">
        ...
        <div className="ml-4 flex-shrink-0">
          <button
            ...
            className={`inline-flex rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-${type.split('-')[0] || 'blue'}-500`}
          >
...
function OrderNotificationManager({ notifications, onRemoveNotification }) {
  return (
    <div>
...
export { OrderNotification, OrderNotificationManager };